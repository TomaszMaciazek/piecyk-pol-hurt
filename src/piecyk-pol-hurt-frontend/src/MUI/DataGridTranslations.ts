...
export const DataGridTranslations: Partial<GridLocaleText> = {
  // Root
  ...
  toolbarFiltersTooltipActive: (count: any) => `Liczba aktywnych filtrów: ${count}`,
  ...
  // Column header text
  columnHeaderFiltersTooltipActive: (count: any) => `Liczba aktywnych filtrów: ${count}`,
  columnHeaderFiltersLabel: 'Pokaż filtry',
  columnHeaderSortIconLabel: 'Sortuj',

  // Rows selected footer text
  footerRowSelected: (count: { toLocaleString: () => any; }) => `Liczba wybranych wierszy: ${count.toLocaleString()}`,
  ...
  groupColumn: (name: any) => `Grupuj według ${name}`,
  unGroupColumn: (name: any) => `Rozgrupuj ${name}`,
